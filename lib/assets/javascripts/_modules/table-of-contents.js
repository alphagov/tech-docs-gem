(function($, Modules) {
  ...
  Modules.TableOfContents = function () {
    ...
    this.start = function ($element) {
      ...
      collapsibleHeadings($topLevelItems);
    ...
    function collapsibleHeadings($elements) {

      var $headings = $elements.find('> a');
      var $listings = $elements.find('> ul');
      var $activeParent = $headings.filter('[href^="' + window.location.pathname + '"]').parent();

      $elements.addClass('collapsible');
